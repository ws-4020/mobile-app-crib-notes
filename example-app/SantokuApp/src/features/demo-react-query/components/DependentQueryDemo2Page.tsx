...
import {useItemInfo} from '../hooks/dependent-query2/useItemInfo';
import {useRefreshUseCase} from '../hooks/dependent-query2/useRefreshUseCase';

export const DependentQueryDemo2Page: React.FC = () => {
  const {data: itemInfo, isIdle, isLoading, isRefetching, isSuccess, isError} = useItemInfo();
