...
import {useRequestPermissionAndRegisterToken as useRequestPermissionAndRegisterTokenService} from '../services/useRequestPermissionAndRegisterToken';
...
export const useRequestPermissionAndRegisterToken = () => {
  const {requestPermissionAndRegisterToken: callRequestPermissionAndRegisterToken} =
    useRequestPermissionAndRegisterTokenService();
