...
const pickerItems: Item<PickerItemType>[] = [
  ...
  {value: {a: '2'}, label: 'test2', key: 2n, inputLabel: 'テスト2'},
  {value: {a: '3'}, label: 'test3', key: 3, inputLabel: 'テスト3'},
  {value: {a: '4'}, label: 'test4', key: 4n, inputLabel: 'テスト4'},
  {value: {a: '5'}, label: 'test5', key: 5, inputLabel: 'テスト5'},
  {value: {a: '6'}, label: 'test6', key: 6n, inputLabel: 'テスト6'},
  {value: {a: '7'}, label: 'test7', key: 7, inputLabel: 'テスト7'},
  {value: {a: '8'}, label: 'test8', key: 8n, inputLabel: 'テスト8'},
  {value: {a: '9'}, label: 'test9', key: 9, inputLabel: 'テスト9'},
  {value: {a: '10'}, label: 'test10', key: 10n, inputLabel: 'テスト10'},
