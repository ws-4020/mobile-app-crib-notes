...
- ADPの[TestFlight](../build/ios/testflight.md)の内部テスターを利用する
- ADEPの[In-House](../build/ios/in-house.md)で配布
- [開発者アカウント](../build/ios/developer-account.md)を使用する
- ADP・ADEPの[AdHoc](../build/ios/ad-hoc.md)でインストールする
...
- ADPの[TestFlight(内部テスター)](../build/ios/testflight.md)で配布
- ADEPの[In-House](../build/ios/in-house.md)で配布
- [開発者アカウント](../build/ios/developer-account.md)でインストール
- ADP・ADEPの[AdHoc](../build/ios/ad-hoc.md)でインストール
...
|配布方法 | TestFlight経由|自前のHTTPSサーバ経由|
 ...
 - [ADPのTestFlight(内部テスター)で配布](../build/ios/testflight.md)
 - [ADEPのIn-House配布](../build/ios/in-house.md)
...
TestFlight(外部テスター)の場合、テスターであるお客様をApp Store Connectのユーザに登録することなく、パブリックリンクを介してお客様のデバイスにアプリを配信できます。もしお客様自身でADP・ADEPライセンスを契約している場合は、そのライセンスを使ってアプリをお客様に配信できます。この場合は、IPAファイルをビルドする時に、お客様の証明書、プロビジョニングプロファイルなどが必要です。
 ...
 - ADPの[TestFlight(外部テスター)](../build/ios/testflight.md)で配布
...
|ユースケース/配布|[個人でUSB経由](../build/ios/developer-account.md)|[AdHoc](../build/ios/ad-hoc.md)|[In-House](../build/ios/in-house.md)|[TestFlight(内部)](../build/ios/testflight.md)|[TestFlight(外部)](../build/ios/testflight.md)|
|:---------|-:-|-:-|-:-|:--|:--|
