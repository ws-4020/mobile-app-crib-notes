...
- [デバイスにUSB経由](../android-local.md)でインストール
...
- [デバイスにUSB経由](../android-local.md)でインストール
- [APKファイルを配布](../android-apk-dist.md)してインストール
- [内部テスト版](../android-google-play-test.md)で配布
...
内部テストやクローズドテストはGoogle Play Consoleがアプリを配布してくれるので、配布の仕組みを自前で用意する必要がありません。
 ...
 - [Google Play](../android-google-play-test.md)でテスト配布
 - [APKファイルを配布](../android-apk-dist.md)
...
配布する範囲を制限したい場合は内部テストやクローズテストで配布してください。
 ...
 - [内部テスト版](../android-google-play-test.md)で配布
 - [クローズドテスト版](../android-google-play-test.md)で配布
...
Androidの場合、オープンテストならGoogle Playで早期アクセス版アプリとして誰でもインストールできる状態になります。
 ...
 - [オープンテスト](../android-google-play-test.md)で配布
