...
- 共通
  ...
  詳細については、[react-native-cliについて](../../common-trap/react-native-cli-uninstall.md)を参照してください。
  :::
...
issueがCloseされていない場合、[XCodeでビルドが失敗する](../../common-trap/cant-build-in-xcode.md)を参照して対応するか、`AwesomeProject`のiOSシミュレータの確認をSkipしてください。
