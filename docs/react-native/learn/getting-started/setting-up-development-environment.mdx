...
- 共通
  ...
  - Android Studio  
    ...
    Android Studioがインストールされていることを確認してください。

    :::caution
    Android Studioがインストールされていない場合、インストールが必要です。
    :::

    Android Studioがインストールされている場合、Android SDKのインストール状況も確認してください。確認方法は、[Android SDK](#android-sdk)を参照してください。
  ...
  - react-native-cli  
    ...
    :::caution
    インストールされていた場合、[react-native-cliについて](/react-native/troubleshooting/react-native-cli-uninstall)を参照してください。
    :::

    上記を参照して、アンインストールしてください。
