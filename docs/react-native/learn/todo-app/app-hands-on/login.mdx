...
:::note
使用方法は[Formikのドキュメント](https://formik.org/docs/overview)を参照してください。
:::
...
:::note
使用方法は[YupのGitHub](https://github.com/jquense/yup)を参照してください。
:::
...
```diff title="/src/screens/auth/index.tsx"
+ export * from './auth';
  export * from './home';
