...
```typescript jsx title="/src/navigation/AuthedStackNav.ts"
...
import {AuthedRootStackParamList} from './types';
...
```typescript jsx title="/src/navigation/UnauthedStackNav.ts"
...
import {UnauthedRootStackParamList} from './types';
...
```typescript jsx title="/src/navigation/RootStackNav.ts"
import {NavigatorScreenParams, RouteProp, useNavigation} from '@react-navigation/native';
import {createStackNavigator, StackNavigationOptions} from '@react-navigation/stack';
