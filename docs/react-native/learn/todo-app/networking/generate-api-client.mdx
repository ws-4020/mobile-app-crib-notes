...
import {RepositoryLink, GithubContentsUrl} from '../../../../../src/components';
...
npx @openapitools/openapi-generator-cli generate -g typescript-fetch -i <GithubContentsUrl path="main/rest-api-specification/openapi.yaml" projectName="mobile-app-hands-on-backend"/> -o src/backend/generated-rest-client --additional-properties supportsES6=true,typescriptThreePlus=true
</code></pre>
