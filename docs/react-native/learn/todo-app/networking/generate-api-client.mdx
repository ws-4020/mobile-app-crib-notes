...
import {RepositoryLink} from '../../../../../src/components';
...
自動生成で利用するOpenAPIドキュメントは<RepositoryLink projectName="mobile-app-hands-on-backend" path="tree/main/rest-api-specification">mobile-app-hands-on-backend</RepositoryLink>で公開されているものを利用します。
...
```console
npx @openapitools/openapi-generator-cli generate -g typescript-fetch -i https://raw.githubusercontent.com/{@inject: organizationName}/mobile-app-hands-on-backend/main/rest-api-specification/openapi.yaml -o src/backend/generated-rest-client --additional-properties supportsES6=true,typescriptThreePlus=true
```
