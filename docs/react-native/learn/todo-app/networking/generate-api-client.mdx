...
自動生成で利用するOpenAPIドキュメント[mobile-app-hands-on-backend](https://github.com/{@inject:organization}/mobile-app-hands-on-backendtree/main/rest-api-specification)で公開されているものを利用します。
