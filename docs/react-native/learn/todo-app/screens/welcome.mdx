...
:::note
`App.tsx` ファイルを編集している場合は、
[プロジェクトの作成](../../getting-started/create-project.md)直後の状態に戻す必要があります。
[プロジェクト作成直後のApp.tsx](https://github.com/ws-4020/rn-spoiler/blob/2021.05.0/template/src/App.tsx)の内容に
上書きしてからToDoアプリの実装をはじめてください。
:::
