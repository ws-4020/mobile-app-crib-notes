...
[地図表示の共通部品](https://github.com/{@inject:organization}/mobile-app-crib-notes/blob/master/example-app/SantokuApp/src/bases/ui/map/MapView.tsx)ではiOSでGoogleマップの使用を制限しています。
