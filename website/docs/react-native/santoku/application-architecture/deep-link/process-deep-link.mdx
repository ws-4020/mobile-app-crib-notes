...
設定により[クリップボードを無効にする](https://firebase.google.com/docs/dynamic-links/ios/receive?hl=ja#set-up-firebase-and-the-dynamic-links-sdk)こともできますが、Dynamic Linksをするため[^1]、インストール後にそのまま起動してディープリンクURLを読み取る機能が利用できません。
