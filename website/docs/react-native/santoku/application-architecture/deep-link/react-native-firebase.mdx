...
Firebase Dynamic Linksは、iOSで初回起動時にコンテンツURLを取得するために[クリップボードを利用するとドキュメントに記載されています](https://firebase.google.com/docs/dynamic-links/operating-system-integrations)が、実際はクリップボードの値だけでなく、デバイス情報なども利用しています。
