...
詳細は、[FirebaseCrashlyticsWorkaround.tsx](https://github.com/{@inject:organization}/mobile-app-crib-notes/tree/master/example-app/SantokuApp/src/apps/app/components/FirebaseCrashlyticsWorkaround.tsx)を参照してください。
:::
