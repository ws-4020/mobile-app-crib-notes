...
:::note
上記を考慮したデータ取得の方法は、（React公式ドキュメント「[パフォーマンス最適化](https://ja.legacy.reactjs.org/docs/hooks-faq.html#performance-optimizations)」のヒント欄で紹介されている）[こちらの記事](https://www.robinwieruch.de/react-hooks-fetch-data/)をご覧ください。
:::
