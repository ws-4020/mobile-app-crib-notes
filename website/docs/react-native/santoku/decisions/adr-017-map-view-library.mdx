...
| :---------------- | :---------------- | :---------------- |:---------------------------------------------------------------------------------------------------------|
| [react-native-maps](https://github.com/react-native-maps/react-native-maps) | iOSは[MapKit](https://developer.apple.com/documentation/mapkit/)か[Google Maps](https://developers.google.com/maps/documentation/ios-sdk?_gl=1*m5krb2*_ga*MTM3NTIyMzkwNC4xNjc4MTc3MTY5*_ga_NRWSTWS78N*MTY4MDE1Mjk2My4xNS4wLjE2ODAxNTI5NjMuMC4wLjA.&hl=ja)。Androidは[Google Maps](https://developers.google.com/maps/documentation/android-sdk?hl=ja)。 | [○](https://docs.expo.dev/versions/latest/sdk/map-view/) | 数ヶ月おきのマイナーアップデートが継続的に行われている。                                                                             |
