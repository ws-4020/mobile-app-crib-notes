...
共有されたURLやQRコードからアプリを開けるようにします。これを実現するために、Firebaseの[Dynamic Links](https://firebase.google.com/docs/dynamic-links)を採用し、以下の方針で利用します。
...
また、ディープリンクの仕組みや詳細について[用語](#用語)を整理しています。
