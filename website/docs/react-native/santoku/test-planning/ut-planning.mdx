...
:::note info
今回はReactおよびReact Nativeの公式ドキュメントで推奨されているツールを選択しました。

- [Recommended Tools(Jest)](https://reactjs.org/docs/testing.html#tools)
- [Component Tests(React Native Testing Library)](https://reactnative.dev/docs/testing-overview#component-tests)
