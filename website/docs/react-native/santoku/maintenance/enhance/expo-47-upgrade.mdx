...
その中で、ライセンス情報が不足していたり、開発時のみ使用するため除外したいライブラリとバージョンを[managed-license.js](https://github.com/{@inject:organization}/mobile-app-crib-notes/blob/v2023.03/example-app/SantokuApp/.script/managed-license.js)で管理しています。
