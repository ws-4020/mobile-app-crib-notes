...
React Native 0.69では、デフォルトでReact 18が有効化されています。React 18はSuspenseのサポートやAutomatic Batching、Transitionsなど[多くの機能がリリース](https://ja.legacy.reactjs.org/blog/2022/03/29/react-v18.html)されています。それらの多くは、**Concurrent Rendering**という基盤に支えられています。
...
- [React v18.0](https://ja.legacy.reactjs.org/blog/2022/03/29/react-v18.html)
