...
- [Expo Config Pluginsで、iOS用に追加したファイルのIDを取得できない問題に対処するパッチ](https://github.com/{@inject:organization}/mobile-app-crib-notes/blob/364337ab6c59ebcb0a51d2ef9711e4896ae965b4/example-app/SantokuApp/patches/README.md#expo-config-pluginsでios用に追加したファイルのidを取得できない問題に対処するパッチ)
...
このアプリでは、[patch-package](https://github.com/ds300/patch-package)を使用して、以下のライブラリにパッチファイルを適用していました。パッチ内容の詳細は、[こちら](https://github.com/{@inject:organization}/mobile-app-crib-notes/blob/364337ab6c59ebcb0a51d2ef9711e4896ae965b4/example-app/SantokuApp/patches/README.md)を参照してください。
...
デフォルトのテストランナーが[jest-jasmine2](https://github.com/jestjs/jest/tree/v29.2.1/packages/jest-jasmine2)から[jest-circus](https://github.com/jestjs/jest/tree/v29.2.1/packages/jest-circus)に変更されるなど、更新内容は多岐にわたります。
...
このアプリでは、使用しているライブラリのライセンス一覧を出力するスクリプトを用意しています。詳細は、[こちら](https://github.com/{@inject:organization}/mobile-app-crib-notes/blob/364337ab6c59ebcb0a51d2ef9711e4896ae965b4/example-app/SantokuApp/.script/README.md)を参照してください。

#### managed-license.jsの更新

ライセンス情報が不足していたり、開発時のみ使用するため除外したいライブラリとバージョンを[managed-license.js](https://github.com/{@inject:organization}/mobile-app-crib-notes/blob/364337ab6c59ebcb0a51d2ef9711e4896ae965b4/example-app/SantokuApp/.script/managed-license.js)で管理しています。
...
そのライセンス名（`BSD 3-Clause`）を[list-dependencies.js](https://github.com/{@inject:organization}/mobile-app-crib-notes/blob/364337ab6c59ebcb0a51d2ef9711e4896ae965b4/example-app/SantokuApp/.script/list-dependencies.js)に追加しています。
