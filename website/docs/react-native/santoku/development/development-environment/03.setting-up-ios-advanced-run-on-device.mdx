...
プッシュ通知やディープリンクなど、[Appの高度な機能](https://help.apple.com/developer-account/?lang=ja#/dev21218dfd6)をデバイスで動かすには無償のデベロッパーアカウントではなく、Apple Developer (Enterprise) Programのライセンスが必要になります。
