...
[^2]:M1アーキテクチャを搭載したMacでCocoaPodsをインストールする場合は、React Native公式のドキュメントに記載されている[Note for Mac M1 users](https://reactnative.dev/docs/environment-setup#cocoapods)を参照してください。
