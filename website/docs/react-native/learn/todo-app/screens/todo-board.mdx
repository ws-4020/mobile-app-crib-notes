...
詳細は、React公式ドキュメントの[フックでデータの取得をどのように行うのですか？](https://ja.legacy.reactjs.org/docs/hooks-faq.html#how-can-i-do-data-fetching-with-hooks)を参照してください。
:::

:::info
`toggleTodoCompletion`では**[関数型の更新](https://ja.legacy.reactjs.org/docs/hooks-reference.html#functional-updates)**を利用しています。
[React公式ドキュメント](https://ja.legacy.reactjs.org/docs/faq-state.html#what-is-the-difference-between-passing-an-object-or-a-function-in-setstate)も参照してみてください。
:::
