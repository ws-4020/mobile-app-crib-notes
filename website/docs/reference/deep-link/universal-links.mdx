...
Universal Linksで作成するURLは以下のようなHTTP URLであるため、1つのURLでアプリとウェブサイトの両方に対応できます。
...
:::note
1つの`associated domain file`を複数のアプリと関連付けるには、[details](https://developer.apple.com/documentation/bundleresources/applinks/details)に複数のアプリを設定します。
